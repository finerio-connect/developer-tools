...
# La generación de opencode.json se movió a lib/opencode-config.sh
# para facilitar el mantenimiento de MCP servers, modelos y agentes.
# Ver: config/base.json, config/mcp-servers.json, config/providers.json, config/agents.json
